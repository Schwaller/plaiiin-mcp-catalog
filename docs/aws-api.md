...
Attribute|Details|
|-|-|
**Docker Image**|[mcp/aws-api-mcp-server](https://hub.docker.com/repository/docker/mcp/aws-api-mcp-server)
...
-|-|-
`cli_command`|`string`|A single command or a list of complete AWS CLI commands to execute
`max_results`|`string` *optional*|Optional limit for number of results (useful for pagination)
...
Parameters|Type|Description
-|-|-
`query`|`string`|A natural language description of what you want to do in AWS. Should be detailed enough to capture the user's intent and any relevant context.
...
![AWS API screenshot 1](https://raw.githubusercontent.com/Schwaller/plaiiin-mcp-catalog/main/docs/img/aws-api-1.png)

![AWS API screenshot 2](https://raw.githubusercontent.com/Schwaller/plaiiin-mcp-catalog/main/docs/img/aws-api-2.png)

![AWS API screenshot 3](https://raw.githubusercontent.com/Schwaller/plaiiin-mcp-catalog/main/docs/img/aws-api-3.png)
